...
class SortSelections extends StatelessWidget {
  const SortSelections({super.key});
      ...
      child: Column(
        children: <Widget>[
          ...
          ListTile(
            ...
            onTap: () {
              Navigator.pop(context, 'trackingStatus');
            },
          ),
          const Divider(),
          ListTile(
...
class FilterSelections extends StatelessWidget {
  const FilterSelections({super.key});
...
class DisplaySelctions extends StatelessWidget {
  const DisplaySelctions({super.key});
